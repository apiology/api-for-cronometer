...
Report bugs at https://github.com/apiology/api-for-cronometer/issues.
...
Ready to contribute? Here's how to set up `api-for-cronometer` for local development.

1. Fork the `api-for-cronometer` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/api-for-cronometer.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv api-for-cronometer
    $ cd api-for-cronometer/
...
3. The pull request should work for Python 3.6, 3.7, 3.8, 3.9, and 3.10. Check
   https://app.circleci.com/pipelines/github/apiology/api-for-cronometer
